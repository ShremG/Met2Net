...
class Encoder(nn.Module):
    ...
    def __init__(self, C_in, C_hid, N_S, spatio_kernel, act_inplace=True):
        ...
        samplings = [True,True,True,False]
        self.enc = nn.Sequential(
              ConvSC(C_in, C_hid, spatio_kernel, downsampling=False, act_inplace=act_inplace),
              Down_wt(C_hid,C_hid),
              ConvSC(C_hid, C_hid, spatio_kernel, downsampling=False, act_inplace=act_inplace),
              Down_wt(C_hid,C_hid),
              ConvSC(C_hid, C_hid, spatio_kernel, downsampling=False, act_inplace=act_inplace),
              Down_wt(C_hid,C_hid),
              ConvSC(C_hid, C_hid, spatio_kernel, downsampling=False, act_inplace=act_inplace),
...
class Decoder(nn.Module):
    ...
    def __init__(self, C_hid, C_out, N_S, spatio_kernel, act_inplace=True):
        ...
        samplings = [False,True,True,True]
