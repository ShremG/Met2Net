...
from openstl.models.ITS.module.superTokenLayer import MidNetSuperToken
...
class SimVP_Model(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        self.hid_q = MidNetSuperToken(in_channels=T*hid_S,d_model=hid_T, n_layers=N_T, heads=8, stoken_size=[8,8])
        self.hid_k = MidNetSuperToken(in_channels=T*hid_S,d_model=hid_T, n_layers=N_T, heads=8, stoken_size=[8,8])
        self.init_weights()
