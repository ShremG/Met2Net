...
from openstl.models.ITS.module.xb_down import Down_wt
...
# from openstl.models.ITS.module.ciatt_supertoken_tokenmixer import CIMidNet

from openstl.models.ITS.module.ciatt_tokenmixersuper_ffnpool import CIMidNet
...
class Encoder(nn.Module):
    ...
    def __init__(self, C_in, C_hid, N_S, spatio_kernel, act_inplace=True):
        ...
        samplings = [False,True,False,True]
        self.enc = nn.Sequential(
              ConvSC(C_in, C_hid, spatio_kernel, downsampling=samplings[0], act_inplace=act_inplace),
              ConvSC(C_hid, C_hid, spatio_kernel, downsampling=samplings[1], act_inplace=act_inplace),
              ConvSC(C_hid, C_hid, spatio_kernel, downsampling=samplings[2], act_inplace=act_inplace),
              ConvSC(C_hid, C_hid, spatio_kernel, downsampling=samplings[3], act_inplace=act_inplace),
        )
...
class Decoder(nn.Module):
    ...
    def __init__(self, C_hid, C_out, N_S, spatio_kernel, act_inplace=True):
        ...
        samplings = [True,False,True,False]
...
if __name__ == '__main__':
    ...
    data = torch.randn((16, 12, 5, 128, 256)).to(device)
    model = SimVP_Model(in_shape=[12,5,128,256],hid_S=32,N_S=4,N_T=8,hid_T=256).to(device)
