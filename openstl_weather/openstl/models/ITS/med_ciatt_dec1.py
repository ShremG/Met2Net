...
class SimVP_Model(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        self.dec_u10_q = Decoder(4*hid_S, 5, N_S, spatio_kernel_dec, act_inplace=act_inplace)
        self.dec_u10_k = Decoder(4*hid_S, 5, N_S, spatio_kernel_dec, act_inplace=act_inplace)
    ...
    def forward(self, x_raw, y_raw, **kwargs):
        ...
        z_y_pre = z_y_pre.reshape(B,4,T,-1,H_, W_).permute(0,2,1,3,4,5).reshape(B*T,-1,H_, W_)


        # 3D DEC
        rec_y = self.dec_u10_q(z_y_pre)
        ...
        # 3D DEC
        pre_y = self.dec_u10_k(z_y_pre.reshape(B*T,-1,H_, W_))
    ...
    def sample(self,batch_x):
        ...
        rec_u10 = self.dec_u10_q(z_y_pre)
