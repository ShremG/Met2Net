...
from openstl.models.simvp_ema.ciatt_modules_pathch_2d import CIMidNet
from openstl.models.simvp_ema.ciatt_modules_patch import CIPatchMidNet
...
class SimVP_Model(nn.Module):
    ...
    def forward(self, x_raw, y_raw, **kwargs):
        ...
        # 3D DEC
        rec_u10 = self.dec_u10_q(h_pre_u10.reshape(B,T,-1,H_,W_).permute(0,2,1,3,4))
        rec_v10 = self.dec_v10_q(h_pre_v10.reshape(B,T,-1,H_,W_).permute(0,2,1,3,4))
        rec_t2m = self.dec_t2m_q(h_pre_t2m.reshape(B,T,-1,H_,W_).permute(0,2,1,3,4))
        rec_tcc = self.dec_tcc_q(h_pre_tcc.reshape(B,T,-1,H_,W_).permute(0,2,1,3,4))
