...
class SimVP_Model(nn.Module):
    ...
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4, N_T=4, model_type='gSTA',
        ...
        self.enc_1 = Encoder(C, hid_S, N_S, spatio_kernel_enc, act_inplace=act_inplace)
        self.dec_1 = Decoder(hid_S, C, N_S, spatio_kernel_dec, act_inplace=act_inplace)
    ...
    def forward(self, x_raw, y_raw, **kwargs):
        ...
        z = z.reshape(B,1,-1, H_, W_)
        hid = self.hid(z)
        hid = hid.reshape(B*T, -1, H_, W_)

        pre_y = self.dec_1(hid)
