...
class SimVP_Model(nn.Module):
    ...
    def forward(self, x_raw, y_raw, **kwargs):
        ...
        rec_u10 = self.dec_u10_q(h_rec_u10)
        rec_v10 = self.dec_v10_q(h_rec_v10)
        rec_t2m = self.dec_t2m_q(h_rec_t2m)
        rec_tcc = self.dec_tcc_q(h_rec_tcc)
...
class Decoder(nn.Module):
    ...
    def __init__(self, C_hid, C_out, N_S, spatio_kernel, act_inplace=True):
        ...
        for i in range(C_out):
            self.readout.append(nn.Conv2d(C_hid, 1, 1))
