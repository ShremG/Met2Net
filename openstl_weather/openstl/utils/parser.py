...
def create_parser():
    ...
    parser.add_argument('--test', action='store_true', default=True, help='Only performs testing')
    ...
    parser.add_argument('--data_root', default='/home/gc/projects/openstl_weather/openstl/data')
    parser.add_argument('--dataname', '-d', default='mmnist', type=str,
                        choices=['bair', 'mfmnist', 'mmnist', 'mmnist_cifar', 'noisymmnist', 'taxibj', 'human',
                                ...
                                'weather_r_1_40625', 'weather_uv10_1_40625', 'weather_tcc_1_40625','weather_mv4my_12_5_625','weather_mv5my_12_5_625', 
                                'weather_mv6my_12_5_625', 'weather_mv8my_12_5_625',
                                'weather_mv9my_12_5_625', 'weather_mv5my_12_1_40625',
